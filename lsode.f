...
C***CATEGORY  I1A
C***TYPE      DOUBLE PRECISION (SLSODE-S, LSODE-D)
...
C           subprograms and Common blocks to LSODE etc. (ACH)
...
C The block DLS001 is declared in subroutines LSODE, DINTDY, DSTODE,
C DPREPJ, and DSOLSY.
